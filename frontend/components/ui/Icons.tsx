...
export function SearchIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} style={size ? { width: size, height: size } : undefined} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function HotelIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m5 10v-5a1 1 0 00-1-1h-2a1 1 0 00-1 1v5m-4 0h-4" />
    </svg>
  );
}
...
export function RestaurantIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1.5 6m9-6l1.5 6m0 0h-9m9 0a3 3 0 11-6 0m6 0a3 3 0 01-6 0" />
    </svg>
  );
}

export function BeautyIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function FitnessIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M4 6h16M4 12h16m-7 6h7M4 18h7M8 6v12m4-12v12" />
    </svg>
  );
}
...
export function TransportIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 16v-4a4 4 0 114 4v4m-4 0h8m-8 0v-4m0 0h8m-8 0h8" />
...
// Ajoute ces icônes dans ton fichier Icons.tsx
...
// components/ui/Icons.tsx
// Ajoute ces icônes dans le fichier existant
...
export function TwitterIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" />
    </svg>
  );
}
...
export function LinkedinIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z" />
...
export function InstagramIcon({ className = "w-6 h-6", size }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" strokeWidth={1.8} />
    </svg>
  );
}