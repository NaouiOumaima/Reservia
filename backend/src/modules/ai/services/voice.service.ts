...
export class VoiceService {
  ...
  private readonly audioCache = new Map<
    string,
  ...
  async textToSpeech(
    ...
    try {
      ...
      const voiceMap: Record<VoiceLanguage, string> = {
        [VoiceLanguage.FR]:
          gender === VoiceGender.FEMALE ? 'fr-FR-Wavenet-C' : 'fr-FR-Wavenet-B',
        [VoiceLanguage.EN]:
          gender === VoiceGender.FEMALE ? 'en-US-Wavenet-C' : 'en-US-Wavenet-B',
        [VoiceLanguage.AR]:
          gender === VoiceGender.FEMALE ? 'ar-XA-Wavenet-C' : 'ar-XA-Wavenet-B',
      };
  ...
  private async simulateSpeechToText(
    _audioBuffer: Buffer,
  ): Promise<SpeechToTextResponseDto> {
